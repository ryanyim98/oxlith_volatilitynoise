...
summary(mod_movement_var_vmu_M10)$coefficients
...
ggsave("../figs/FIG4_movement_n_time.png",width = 7 ,height=9,dpi = 300)
...
pD3 <- plot_model(cD3, type = "pred", terms = c("time_M10_s","Allocation","phase"), show.data = F)+
  ...
  scale_fill_manual(values=orangeNavyPalette)+
  labs(title = "",
       x = "daytime movement onset time noise",
       y = "PA noise")+
  theme(legend.position = "none")
